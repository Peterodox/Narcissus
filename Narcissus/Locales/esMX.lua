...
L["LFR Wing Details"] = "Detalles de las alas de lfr";
L["LFR Wing Details Description"] = "Muestra los nombres de los jefes y los bloqueos cuando hablas con los PNJs de cola única de lfr.";
...
--Misión--
L["Auto Display Quest Item"] = "Mostrar descripciones de objetos de misión automáticamente";
L["Drag To Move"] = "Arrastra para mover";
L["Middle Click Reset Position"] = "Haz clic medio para restablecer la posición."
